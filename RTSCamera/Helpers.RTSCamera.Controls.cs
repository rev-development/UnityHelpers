...
namespace Helpers.RTSCamera
{
	...
	public class Controls : MonoBehaviour
	{
		...
		private DefaultControls.DevCameraActions _actions;
		...
		private void Awake()
		{
			...
			_actions = _defaultControls.DevCamera;
		...
		public void Rotate()
		{
			_mainCamera.transform.localEulerAngles = new Vector3(
				Mathf.Clamp(
					_mainCamera.transform.localEulerAngles.x - _rotateInput.y * Config.RotateSpeed * Time.deltaTime,
